 ...
 * the credential gets one of them wrong. Use `AdtOnPremConnector` with `CertificateAuthProvider`:
 *
 *   new AdtOnPremConnector(config, new CertificateAuthProvider(loader, config), logger)
 *
